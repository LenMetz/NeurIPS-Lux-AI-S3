...
class Agent():
    ...
    def act(self, step: int, obs, remainingOverageTime: int = 60):
        ...
        for unit in available_unit_ids.copy():
            ...
            if self.tile_map.map[int(self.unit_targets[unit][0]),int(self.unit_targets[unit][1])]==2:
        ...
        for unit in range(self.n_units):
            if unit_mask[unit]:
                ...
                if self.unit_path[unit]:
                    #print(unit, unit_pos, self.unit_path[unit])
                    ...
                    actions[unit]=[0,0,0]
        #if step in [101,102,103,104,105,106,107,108]:
            #print("Step: ", step, unit_positions, self.unit_path, actions)
